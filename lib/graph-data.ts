...
export const NODES: ConceptNode[] = [
  // ── Thinkers ──────────────────────────────────────────
  { id: "hegel", label: "Hegel", category: "thinker", core: true, chapters: ["11-the-hegel-popper-kuhn-pearl-synthesis"], description: "Dialectical progression: thesis-antithesis-synthesis as empirically observable pattern" },
  { id: "popper", label: "Popper", category: "thinker", core: true, chapters: ["05-popper-and-falsifiability", "11-the-hegel-popper-kuhn-pearl-synthesis"], description: "Falsifiability criterion: genuine knowledge must specify what would disprove it" },
  { id: "kuhn", label: "Kuhn", category: "thinker", core: true, chapters: ["06-kuhn-and-paradigm-shifts", "11-the-hegel-popper-kuhn-pearl-synthesis"], description: "Paradigm shifts: scientific revolutions as gestalt changes, not logical deductions" },
  { id: "pearl", label: "Pearl", category: "thinker", core: true, chapters: ["10-judea-pearl-and-causal-graphs", "11-the-hegel-popper-kuhn-pearl-synthesis"], description: "Causal inference: do-calculus, three-level hierarchy of association, intervention, counterfactual" },
  { id: "boyd", label: "Boyd", category: "thinker", core: true, chapters: ["11-the-hegel-popper-kuhn-pearl-synthesis"], description: "Dialectic Engine: destruction and creation cycle, OODA loop, tempo as competitive advantage" },
  { id: "hofstadter", label: "Hofstadter", category: "thinker", core: true, chapters: ["16-trinity-as-strange-loop", "26-free-will-determinism-plekhanov"], description: "Strange loops, Godel Escher Bach, self-reference generating consciousness" },
  ...
  { id: "girard", label: "Girard", category: "thinker", core: true, chapters: ["21-antichrist-epstein-and-structural-evil"], description: "Scapegoat mechanism: societies channel collective violence onto sacrificial victim" },
  ...
  // ── Frameworks ─────────────────────────────────────────
  { id: "riemann-sphere", label: "Riemann Sphere", category: "framework", core: true, chapters: ["20-the-riemann-sphere-theology", "A-mathematical-appendix"], description: "God as point at infinity on the compactified complex plane; all trajectories converge" },
  { id: "causal-hierarchy", label: "Causal Hierarchy", category: "framework", core: true, chapters: ["10-judea-pearl-and-causal-graphs", "A-mathematical-appendix"], description: "Association (seeing), intervention (doing), counterfactual (imagining) — three irreducible levels" },
  { id: "ooda-loop", label: "OODA Loop", category: "framework", core: true, chapters: ["11-the-hegel-popper-kuhn-pearl-synthesis", "27-the-apostolic-task"], description: "Observe-Orient-Decide-Act: faster cycles produce competitive advantage" },
  { id: "dialectical-engine", label: "Dialectical Engine", category: "framework", core: true, chapters: ["11-the-hegel-popper-kuhn-pearl-synthesis"], description: "Boyd's synthesis of Godel + Heisenberg + thermodynamics: Structure → Unstructure → Restructure" },
  { id: "strange-loop", label: "Strange Loop", category: "framework", core: true, chapters: ["16-trinity-as-strange-loop", "26-free-will-determinism-plekhanov"], description: "Self-referential hierarchy producing genuine novelty; consciousness from formal system modeling itself" },
  ...
  { id: "republic-model", label: "Republic of AI Agents", category: "framework", core: true, chapters: ["25-republic-of-ai-agents", "27-the-apostolic-task"], description: "Philosopher-kings (humans) + merchants (data agents) + warriors (implementation agents)" },
  { id: "samsaric-cycle", label: "Samsaric Cycle", category: "framework", core: true, chapters: ["19-the-cyclical-christ-samsara-nirvana"], description: "Each epoch: capture → prophecy → crucifixion → resurrection → Pentecost → capture" },
  ...
  // ── Core Concepts ──────────────────────────────────────
  { id: "falsifiability", label: "Falsifiability", category: "concept", core: true, chapters: ["05-popper-and-falsifiability"], description: "Genuine knowledge must specify what would disprove it; unfalsifiable claims are ideology" },
  { id: "paradigm-shift", label: "Paradigm Shift", category: "concept", core: true, chapters: ["06-kuhn-and-paradigm-shifts"], description: "Gestalt revolution in perception; anomaly accumulation → crisis → revolution" },
  { id: "strong-emergence", label: "Strong Emergence", category: "concept", core: true, chapters: ["07-complexity-science-and-emergence", "A-mathematical-appendix"], description: "Higher-order property genuinely real and causally efficacious, not just convenient description" },
  { id: "free-will", label: "Free Will", category: "concept", core: true, chapters: ["26-free-will-determinism-plekhanov", "A-mathematical-appendix"], description: "Godelian truth: consistent with physical law but not derivable from it; the derivative freely chosen" },
  { id: "derivative", label: "The Derivative", category: "concept", core: true, chapters: ["20-the-riemann-sphere-theology", "A-mathematical-appendix"], description: "Direction of movement on the complex plane; approaching or receding from the point at infinity" },
  ...
  { id: "neurodivergence", label: "Neurodivergence", category: "concept", core: true, chapters: ["01-neurodivergence-and-consciousness", "32-mental-health-crisis"], description: "Alternative cognitive architectures with distinct advantages and costs; not malfunction but configuration" },
  { id: "embodied-theology", label: "Embodied Theology", category: "concept", core: true, chapters: ["22-sexual-liberation-and-embodied-theology"], description: "Body as primary vehicle of transcendence; sexual energy as creative force oriented toward infinity" },
  ...
  { id: "normie", label: "Normie", category: "diagnosis", core: true, chapters: ["02-normies-psychos-schizos"], description: "Prosocial majority; cognition optimized for cooperation and trust; systematically exploitable" },
  { id: "psycho", label: "Psycho", category: "diagnosis", core: true, chapters: ["02-normies-psychos-schizos"], description: "Dark triad; cognition optimized for manipulation and simulation of prosocial behavior" },
  { id: "schizo", label: "Schizo", category: "diagnosis", core: true, chapters: ["02-normies-psychos-schizos", "03-the-prophetic-function"], description: "Pattern recognition unconstrained by social consensus; sees through masks" },
  { id: "prophetic-function", label: "Prophetic Function", category: "diagnosis", core: true, chapters: ["03-the-prophetic-function"], description: "Institutional role for unconstrained perception; dismantled by modernity" },

  // ── Theological Concepts ───────────────────────────────
  { id: "trinity", label: "Trinity", category: "theological", core: true, chapters: ["16-trinity-as-strange-loop"], description: "Father (formal system), Son (Godelian statement), Spirit (process of self-reference)" },
  { id: "fall", label: "The Fall", category: "theological", core: true, chapters: ["14-the-fall-as-felix-culpa"], description: "Felix culpa: initialization of the trajectory; cannot approach infinity without first moving" },
  { id: "christ-event", label: "Christ-Event", category: "theological", core: true, chapters: ["15-new-testament-redemption", "19-the-cyclical-christ-samsara-nirvana"], description: "Removable singularity: apparent discontinuity revealed as smooth from higher-dimensional view" },
  { id: "holy-spirit", label: "Holy Spirit", category: "theological", core: true, chapters: ["16-trinity-as-strange-loop", "A-mathematical-appendix"], description: "Process of self-reference; intuition as precision-weighted habitual inference" },
  { id: "antichrist", label: "Antichrist", category: "theological", core: true, chapters: ["21-antichrist-epstein-and-structural-evil"], description: "Systemic mimicry of Christ; appearance of light concealing structural predation" },
  ...
  { id: "point-at-infinity", label: "Point at Infinity", category: "theological", core: true, chapters: ["20-the-riemann-sphere-theology", "00-introduction"], description: "God: the element completing the space; every trajectory approaches, none arrives" },
  ...
  { id: "apostolic-task", label: "Apostolic Task", category: "theological", core: true, chapters: ["27-the-apostolic-task"], description: "Five-phase sequence: monastery → marketplace → network → society → politics" },
  ...
  // ── Societal Crises ────────────────────────────────────
  { id: "male-loneliness", label: "Male Loneliness", category: "crisis", core: true, chapters: ["31-male-loneliness-crisis"], description: "Missing synthesis between traditional patriarchy and anomic individualism" },
  ...
  { id: "ai-safety", label: "AI Safety", category: "crisis", core: true, chapters: ["33-ai-safety-automation"], description: "AI as both most powerful psycho-class tool and most powerful prophetic instrument" },
  { id: "inequality", label: "Economic Inequality", category: "crisis", core: true, chapters: ["34-economic-inequality"], description: "Information asymmetry as primary extraction mechanism; complexity as weapon" },
  ...
  { id: "meaning-crisis", label: "Meaning Crisis", category: "crisis", core: true, chapters: ["38-the-meaning-crisis"], description: "Meta-crisis: modernity killed God, postmodernity killed grand narratives, nothing replaced them" },
...
export const EDGES: ConceptEdge[] = [
  ...
  { source: "girard", target: "antichrist", type: "builds_on", strength: 0.7, label: "Scapegoat mechanism" },
  ...
  // ── The Great Synthesis (Chapter 11) ───────────────────
  ...
  { source: "strong-emergence", target: "trinity", type: "formalizes", strength: 0.75, label: "God emerges strongly" },
  ...
  { source: "embodied-theology", target: "christ-event", type: "builds_on", strength: 0.7, label: "Incarnation affirms body" },
...
// ── Helpers for graph mode filtering ─────────────────────

const CORE_NODE_IDS = new Set(NODES.filter((n) => n.core).map((n) => n.id));

export function getCoreNodes(): ConceptNode[] {
  return NODES.filter((n) => n.core);
}

export function getCoreEdges(): ConceptEdge[] {
  return EDGES.filter((e) => CORE_NODE_IDS.has(e.source) && CORE_NODE_IDS.has(e.target));
}
